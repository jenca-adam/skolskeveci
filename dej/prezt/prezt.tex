...
\setbeamertemplate{caption}{\centering\raggedright\insertcaption\par}
...
\end{frame}
\begin{frame}{\small \textcolor{red}{Barok} / \Large Nástroje}
	...
	\end{columns}
\end{frame}
\begin{frame}{\small \textcolor{red}{Barok} / \Large Skladatelia}
...
\begin{frame}{Klasicizmus}
	...
	\end{figure}
\end{frame}
\begin{frame}{\small \textcolor{red}{Klasicizmus} / \Large Skladatelia}
	\subsubsection{Skladatelia}
	\begin{columns}
	\column{0.7\textwidth}
...
\begin{frame}{17. storočie}
	...
	\end{itemize}
\end{frame}
\begin{frame}{\small \textcolor{red}{17. storočie} / \Large Významní spisovatelia 17. storočia}
...
\begin{frame}{\small{\textcolor{red}{18. storočie}} / \Large Významní spisovatelia 18. storočia}
...
\begin{frame}{Baroková architektúra}
	...
	\end{itemize}
		...
		\end{figure}
\end{frame}
\begin{frame}{\small \textcolor{red}{Baroková architektúra} / \Large Raný barok}
	...
	\end{itemize}
\end{frame}
\begin{frame}{\small \textcolor{red}{Baroková architektúra} / \Large Vrcholný barok}
	...
	\end{itemize}
\end{frame}
\begin{frame}{\small \textcolor{red}{Baroková architektúra} / \Large Neskorý barok}
...
\begin{frame}{Barok}
	...
	\end{columns}
\end{frame}
\begin{frame}{\small \textcolor{red}{Barok} / \Large Námety}
...
\end{frame}
\begin{frame}{\small \textcolor{red}{Barok} / \Large Predstavitelia}
